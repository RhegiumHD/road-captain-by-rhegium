  ...
  if (url.pathname === "/api/plan" && req.method === "POST") {
    ...
    req.on("end", async()=>{
      try {
        ...
        // Andatura: Rapida = +10% velocita' (tempi ridotti), Relax = -10% (tempi aumentati), Normale = reale.
        const paceFactor = b.pace === "rapida" ? (1/1.10) : b.pace === "relax" ? (1/0.90) : 1;
        const durH = rt.durationHours * paceFactor;
