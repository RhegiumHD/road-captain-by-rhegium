...
// CARREGGIATA: tra due aree vicine, scegli quella sulla tua corsia (lato destro), non la gemella opposta.
const side = planFuelStops({
  routeKm:500,
  pois:[{name:"AreaOpposta",routeKm:168,offsetMeters:30,onMotorway:true,side:"left"},{name:"AreaTua",routeKm:170,offsetMeters:50,onMotorway:true,side:"right"}],
  stopEveryKm:150, forwardWindowKm:25, maxAutonomyKm:200
});
