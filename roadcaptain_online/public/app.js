...
$("calcBtn").onclick=async()=>{
  ...
  try{
    ...
    if ($("avgSpeed")) { const dh=(tt.driveMinutes!=null?tt.driveMinutes:d.route.durationHours*60)/60; $("avgSpeed").textContent = dh>0 ? Math.round(d.route.distanceKm/dh)+" km/h" : "—"; }
    ...
    $("routePois").innerHTML = routePois.length ? routePois.map((p,i)=>{
