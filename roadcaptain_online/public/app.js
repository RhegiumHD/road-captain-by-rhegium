...
(function(){
  ...
  $("fbSend").onclick = async () => {
    ...
    try {
      ...
      if (r.ok && d.ok){ $("fbStatus").textContent = d.delivered ? "Grazie! Feedback inviato." : "Grazie! Feedback registrato (email non recapitata, ma l'ho salvato)."; $("fbMessage").value=""; $("fbContact").value=""; setTimeout(close, 1500); }
