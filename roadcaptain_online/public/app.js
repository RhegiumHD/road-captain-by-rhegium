...
(function(){
  ...
  $("fbSend").onclick = async () => {
    ...
    try {
      ...
      if (r.ok && d.ok){ $("fbStatus").textContent = d.delivered ? "Grazie! Feedback inviato." : ("Salvato. Diagnostico: " + (d.diag || "—")); $("fbMessage").value=""; $("fbContact").value=""; if (d.delivered) setTimeout(close, 1500); }
