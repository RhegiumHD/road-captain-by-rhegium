...
export function planFuelStops({routeKm, pois, stopEveryKm=150, forwardWindowKm=25, maxAutonomyKm=200}) {
  ...
  while (routeKm - lastKm > maxAutonomyKm) {
    ...
    // Carreggiata corretta: l'area sulla TUA corsia e' a destra del senso di marcia.
    // Se ce n'e' almeno una a destra, scarta quelle della carreggiata opposta (a sinistra).
