...
async function calculate() {
  ...
  try {
    ...
    renderPlan(plan);
    log((plan.schedule?.mode === "arrive" ? "Itinerario calcolato in modalità arrivo entro. " : "Itinerario calcolato in modalità partenza alle. ") + (plan.route.tollTotal === null ? "Nota: " + plan.route.tollStatus : ""));
  } catch (err) {
...
function refreshModeLabels() {
  ...
  document.body.dataset.travelMode = $("mode").value;
}
